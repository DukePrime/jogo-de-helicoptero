function start() { // Inicio da função start()
    ...
    function movejogador() {
        ...
        if (jogo.pressionou[TECLA.W]) {
            ...
            // limita o movimentação da jogador na parte superior do background
            if (topo <= 0) {
    ...
    function bombadisparo() {
        ...
        if (podeAtirar == true) {
            ...
            $("#bomba").css("top", topoTiro);
            $("#bomba").css("left", tiroX);
        ...
        function executaDisparo() {
            topo = parseInt($("#bomba").css("top"));
            $("#bomba").css("top", topo + 15);
    ...
    function colisao() {
        ...
        var colisao7 = ($("#bomba").collision($("#inimigo1")));
        var colisao8 = ($("#bomba").collision($("#inimigo2")));
